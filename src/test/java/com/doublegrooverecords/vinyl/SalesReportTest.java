...
public class SalesReportTest {
    ...
    public void returnsZero() throws Exception {
        // arrange
        long id = 1L;
        Product p = new Product(-1L, null, null, null, null, null, id);
        Method findIndexOf = QuarterlySalesReport.class.getDeclaredMethod("findIndexOf", ArrayList.class, Product.class);
        findIndexOf.setAccessible(true);
    ...
    class getMostPurchased {
        ...
        public void listHasOneItem_whenThereIsOneItemInOneOrder() {
            Product expectedProduct = new Product(1L, null, null, null, null, null, null);
        ...
        public void productsAreInCountOrder_whenOneOrderContainsSeveralProducts() {
            Product productOne = new Product(1L, null, null, null, null, null, null);
            Product productTwo = new Product(2L, null, null, null, null, null, null);
    ...
    public void getProfit() throws Exception {
        ...
        Order o = new Order();
        Product aProduct = new Product(1L, null, null, null, new BigDecimal("10"), new BigDecimal("2"), null);
    ...
    public void getAmountOwedToManufacturers() throws Exception {
        ...
        Product first = new Product(1L, null, null, null, new BigDecimal("10"), cost, 1L);
        Product second = new Product(2L, null, null, null, new BigDecimal("10"), cost, 1L);
        Order o = new Order();
